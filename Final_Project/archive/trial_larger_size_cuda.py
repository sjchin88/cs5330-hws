...
class MyNetwork(nn.Module):
    ...
    def __init__(self, square_size, num_filter_conv1=10, num_filter_conv2=20, num_hidden_node=50, num_output=10):
        ...
        print(f"ratio:{ratio}, num_hidden_node:{num_hidden_node}")
...
def main(argv):
    ...
    result_save_path = dir_model + "/results_2layer_large/"
    if not os.path.exists(result_save_path):
        os.makedirs(result_save_path)
        # return None

    # Initialize the network and optimizer
    network = MyNetwork(target_size, num_filter_conv1=10,
                        num_filter_conv2=20, num_output=len(labels_dict))

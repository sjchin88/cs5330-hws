...
class CNN3Network(nn.Module):
    ...
    def __init__(self, square_size, num_filter_conv1=5, num_filter_conv2=10, num_filter_conv3=20, num_hidden_node=320, num_output=185):
        """_summary_
...
def main(argv):
    ...
    result_save_path = dir_model + "/results_3layers_small/"
    if not os.path.exists(result_save_path):
        os.makedirs(result_save_path)
        # return None

    # Initialize the network and optimizer
    network = CNN3Network(92, num_filter_conv1=5,
                          num_filter_conv2=10, num_filter_conv3=20, num_hidden_node=320, num_output=185)
